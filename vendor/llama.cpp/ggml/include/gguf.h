...
GGML_API int64_t        gguf_find_tensor(const struct gguf_context * ctx,
                                         const char *                name);  // returns -1 if the tensor is not found
...
GGML_API void gguf_set_arr_data(struct gguf_context * ctx,
                                const char *          key,
                                enum gguf_type        type,
                                const void *          data,
                                size_t                n);
